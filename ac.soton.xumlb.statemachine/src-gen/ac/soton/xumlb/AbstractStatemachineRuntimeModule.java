...
import ac.soton.xumlb.formatting2.StatemachineFormatter;
import ac.soton.xumlb.generator.StatemachineGenerator;
import ac.soton.xumlb.parser.antlr.StatemachineAntlrTokenFileProvider;
import ac.soton.xumlb.parser.antlr.StatemachineParser;
import ac.soton.xumlb.parser.antlr.internal.InternalStatemachineLexer;
import ac.soton.xumlb.scoping.StatemachineScopeProvider;
import ac.soton.xumlb.serializer.StatemachineSemanticSequencer;
import ac.soton.xumlb.serializer.StatemachineSyntacticSequencer;
import ac.soton.xumlb.services.StatemachineGrammarAccess;
import ac.soton.xumlb.validation.StatemachineConfigurableIssueCodesProvider;
import ac.soton.xumlb.validation.StatemachineValidator;
...
public abstract class AbstractStatemachineRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "ac/soton/xumlb/Statemachine.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("ac.soton.xumlb.Statemachine");
	}
